...
import githubSearchRepositoryImpl from '@modules/github-search/repositories/github-search.repository';
...
httpClient.updateConfig({
  baseUrl: envConfig.githubSearchBaseUrl,
});

export const githubSearchApiService = {
  search: githubSearchRepositoryImpl(),
};
